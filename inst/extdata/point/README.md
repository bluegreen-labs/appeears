...
## 1. Request Parameters  
    ...
    Date Completed:** 2023-05-13T10:59:52.524679  

    ID: 07bc1b61-db0e-4bda-bbda-592a0cb3518e  
...
- JSON request file which can be used in AppEEARS to create a new request
  - point-request.json
- xml file
  - point-MCD12Q2-006-metadata.xml  
